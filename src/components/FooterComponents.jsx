        ...
        <Row className="d-flex justify-content-between">
          <Col lg="5">
            ...
            <p className="desc">
              ...
              neque sequi dolores facilis repudiandae nisi optio ipsa ullam
              nulla. Modi.
            </p>
            <div className="no mb-1 mt-4">
              <Link className="text-decoration-none">
                <i className="fa-brands fa-whatsapp"></i>
                <p className="m-0">+62 851-3489-5425</p>
              </Link>
            </div>
            <div className="mail">
              <Link className="text-decoration-none">
        ...
        <Row>
          <Col>
            <p className="text-center px-md-0 px-3">
              ...
              <span className="fw-bold">by Ngoding Mastery</span>, All Right
              Reserved
            </p>
          </Col>
        </Row>
